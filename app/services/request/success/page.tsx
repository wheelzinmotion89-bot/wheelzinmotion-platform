...
export default function ServiceRequestSuccessPage() {
  ...
  const service = searchParams.get("service") || "Service Request";
      ...
      <main className="flex min-h-screen items-center justify-center bg-black px-6 py-32 text-white">
        <section className="w-full max-w-3xl rounded-3xl border border-purple-500/30 bg-zinc-950 p-8 text-center shadow-[0_0_60px_rgba(147,51,234,.35)] md:p-12">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-zinc-300">
            ...
            submitted successfully. WheelzInMotion will review the information
            and reply by email.
          </p>
          ...
          <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              href="/"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-purple-600 px-8 py-4 font-bold transition hover:bg-purple-500"
            >
              <Home size={20} />
              Return Home
            </Link>
